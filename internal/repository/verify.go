...
func (r *Repository) VerifyCommit(ctx context.Context, ids ...string) (map[string]string, error) {
	slog.Debug("Verifying commit signature...")
	return policy.VerifyCommit(ctx, r.r, ids...)
}

func (r *Repository) VerifyTag(ctx context.Context, ids []string) (map[string]string, error) {
